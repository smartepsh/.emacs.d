...
#+begin_src emacs-lisp
  ...
  (use-package lsp-bridge
    ...
    :config
    (push 'lisp-mode-hook lsp-bridge-default-mode-hooks)
    (setq acm-fetch-candidate-doc-delay 1
          acm-enable-doc nil
          acm-enable-copilot nil
          ;; "copilot-candidates"
          acm-completion-backend-merge-order '("template-first-part-candidates" "copilot-candidates" "mode-first-part-candidates" "tabnine-candidates" "template-second-part-candidates" "mode-second-part-candidates"))
    :general
    (general-define-key
